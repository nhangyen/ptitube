...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    type VARCHAR(30) NOT NULL CHECK (type IN ('like', 'comment', 'follow', 'reply', 'video_approved', 'video_rejected')),
...
-- ============================================================
INSERT INTO users (username, email, password_hash, avatar_url, bio, role, is_verified)
VALUES ('admin', 'admin@ptitube.com', '$2b$10$P/dNzrQ74MF8MxN8xeoVsuk70XE9gH/JokrXanTU3KAnkP6EWxYH2', 'https://i.pravatar.cc/150?u=admin', 'System Administrator', 'admin', TRUE)
